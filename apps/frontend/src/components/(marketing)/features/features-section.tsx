...
function FeatureCard({ 
  ...
  return (
    <motion.div 
      ...
      className="p-6 rounded-xl bg-white shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-pointer"
    >
      <div className="mb-4 inline-flex items-center justify-center h-12 w-12 rounded-xl bg-brand-gradient shadow-md">
        <Icon className="h-6 w-6 text-white" />
      </div>
      <h3 className="h4 mb-2 text-brand-gradient">{title}</h3>
