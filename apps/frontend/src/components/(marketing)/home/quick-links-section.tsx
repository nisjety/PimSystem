          ...
          {quickLinks.map((link) => {
            ...
            return (
              ...
              >
                <Link
                  href={link.href}
                  className="group relative flex flex-col rounded-2xl border border-default bg-white/80 backdrop-blur-md p-6 shadow-sm transition-all hover:shadow-md h-full"
                >
                  <div
