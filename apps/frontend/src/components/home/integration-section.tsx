...
const partners = [
  ...
  { name: "BigCommerce", logo: "/partners/bigcommerce.svg", url: "https://login.bigcommerce.com/" },
...
export function IntegrationSection() {
  return (
    <section className="py-20 bg-background dark:bg-cream-900 relative overflow-hidden">
      {/* Silky-wave pattern */}
        ...
        >
          <h2 className="text-4xl font-bold text-foreground mb-4">
            ...
            <span className="relative">
              <span className="relative z-20">Favorite Platforms</span>
